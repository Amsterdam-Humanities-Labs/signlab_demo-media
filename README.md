...
- Readers: [signlab_signCollect-v2](https://github.com/Amsterdam-Humanities-Labs/signlab_signCollect-v2) (`js/main.js`, `js/table.js`), [signlab_zinnen-annotation](https://github.com/Amsterdam-Humanities-Labs/signlab_zinnen-annotation) (`getZinnen.php`), and [signlab_studio-archive](https://github.com/Amsterdam-Humanities-Labs/signlab_studio-archive). signlab_studio-archive asks for the thumbnail of every angle, which is why the A/B angles and the thumbnails are here.
